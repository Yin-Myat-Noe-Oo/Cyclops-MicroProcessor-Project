...
#               "november", "december"]  # For mapping months in number to words
...
#     mixer.music.load(r'D:/Cyclops/Cyclops-main/Cyclops/music_and_tones/deep-ambient-version-60s-9889.mp3')
...
#     match f_name:
#         case "show_image":
#             send_data("#" + res, LOOP_ARD)
#             image_name = func[brack_start + 1:brack_end]
#             if len(image_name) < 1:
#                 image_name = res.split()[-2]
#             scrape_images(image_name)
#             pics = os.listdir(r"D:/Cyclops/Cyclops-main/Cyclops/images_temp")
#             img_list = []
#             img = np.zeros([255, 255])
#             for path in range(0, len(pics)):
#                 if image_name in pics[path]:
#                     img = cv.imread(r"D:/Cyclops/Cyclops-main/Cyclops/images_temp/" + pics[path])
#                     img = cv.resize(img, (500, 350))
#                     os.remove(r"D:/Cyclops/Cyclops-main/Cyclops/images_temp/" + pics[path])
#                     img_list.append(img)
...
#                 for i in range(0, AFTER_KEYWORD):  # After cyclops keyword recognition, it runs for specified number of times
#                     if i > 0:
...
#                     elif ("what" in audio_inp or "whats" in audio_inp or "what's" in audio_inp) and "temperature" in audio_inp and "room" in audio_inp:
...
#                         mixer.init()
#                         mixer.music.load(
#                             r'D:/Cyclops/Cyclops-main/Cyclops/music_and_tones/short-warm-piano-prelude-intro-ending-for-film-and-video-182969.mp3')
